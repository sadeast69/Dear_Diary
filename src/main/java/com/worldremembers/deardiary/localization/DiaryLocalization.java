...
public final class DiaryLocalization {
    ...
    public static String localeFor(ServerPlayerEntity player) {
    ...
    public static String resolveFor(ServerPlayerEntity player, String key, String fallbackWhenKeyMissing) {
    ...
    private static String clientLanguage(ServerPlayerEntity player) {
        if (player == null) {
            return "";
        }

        SyncedClientOptions options = player.getClientOptions();
        return options == null ? "" : options.language();
    }
