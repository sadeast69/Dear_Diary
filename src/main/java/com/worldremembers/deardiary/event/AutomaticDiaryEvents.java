...
public final class AutomaticDiaryEvents {
     ...
     */
    public static Optional<DiaryEntry> trigger(ServerPlayerEntity player, String eventId) {
     ...
     */
    public static Optional<DiaryEntry> trigger(ServerPlayerEntity player, String eventId, boolean force) {
     ...
     */
    public static Optional<DiaryEntry> trigger(ServerPlayerEntity player, AutomaticEventDefinition definition, boolean force) {
     ...
     */
    public static int incrementCounter(ServerPlayerEntity player, String eventId, int amount) {
        PlayerDiary diary = DearDiaryApi.getDiary(player);
     ...
     */
    public static List<DiaryEntry> incrementCounterAndTriggerMilestones(ServerPlayerEntity player, String counter, int amount) {
